...
static int run_init() {
    ...
    config_file<< "var version = \"17\"\n";
    config_file<< "VERSION(version)\n";
    config_file<< "\n";
    config_file<< "// tmake config debug->\n";
    config_file<< "if \"$1\" == \"debug\" {\n";
    config_file<< "    PROGRAM(program_name, files, debug_flags, output_directory)\n";
    config_file<< "}\n";
    config_file<< "// tmake config release->\n";
    config_file<< "else if \"$1\" == \"release\" {\n";
    config_file<< "    PROGRAM(program_name, files, release_flags, output_directory)\n";
    config_file<< "}\n";
